...
Documento de contexto para o projeto orquestrador e para o agente. Resume o que foi decidido, o que existe e o que falta. Consolidado após a rodada 28 (20/09/2026). Fica em `docs/` no repositório e na base de conhecimento do orquestrador; se um muda, o outro muda.
...
static/
  css/app.css      seção 1 tokens do design system, UMA camada desde a 28 (paleta --grafico-*, --esqueleto, a
                   ...
                   Orçamento, rodada 28); 6 login (380px, .login-titulo); 7 responsivo; 8 utilitários (.negativo
                   global desde a 16). Seção 5.7 (modal) removida na 17; lacuna intencional, a única — componente
                   novo entra no fim. ~4.670 linhas
